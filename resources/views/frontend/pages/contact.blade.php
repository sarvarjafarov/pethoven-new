        ...
        <div class="row">
            <div class="offset-lg-6 col-lg-6">
                ...
                <div class="section-title position-relative">
                    <h2 class="title">{{ setting('contact.title', 'Get in touch') }}</h2>
                    <p class="m-0">{{ setting('contact.description', 'Lorem ipsum dolor sit amet, consectetur adipiscing aliquam, purus sit amet luctus venenatis') }}</p>
    ...
    <div class="container">
        <div class="contact-info">
            <div class="contact-info-item">
                ...
                @php $phone1 = setting('contact.phone1', '+11 0203 03023'); $phone2 = setting('contact.phone2', '+11 0203 03023'); @endphp
                <a href="tel:{{ preg_replace('/[^+0-9]/', '', $phone1) }}">{{ $phone1 }}</a>
                <a href="tel:{{ preg_replace('/[^+0-9]/', '', $phone2) }}">{{ $phone2 }}</a>
            </div>
            <div class="contact-info-item">
                <img class="icon" src="{{ $cdn }}/icons/2.webp" width="30" height="30" alt="Icon">
                <a href="mailto:{{ setting('contact.email1', 'example@demo.com') }}">{{ setting('contact.email1', 'example@demo.com') }}</a>
                <a href="mailto:{{ setting('contact.email2', 'demo@example.com') }}">{{ setting('contact.email2', 'demo@example.com') }}</a>
            </div>
            <div class="contact-info-item mb-0">
                <img class="icon" src="{{ $cdn }}/icons/3.webp" width="30" height="30" alt="Icon">
                <p>{{ setting('contact.address', 'Sunset Beach, North Carolina(NC), 28468') }}</p>
            </div>
        </div>
    </div>
</section>
